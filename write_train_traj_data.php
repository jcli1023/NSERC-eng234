...
if (!file_exists("test_traj_data_batch.txt"))
{
	$fp2 = fopen('test_traj_data_batch.txt', 'w');
	$new_traj_data = "@relation trajdataTestSVMBatch
...
{
	$fp2 = fopen('test_traj_data_batch.txt', 'a');
}
